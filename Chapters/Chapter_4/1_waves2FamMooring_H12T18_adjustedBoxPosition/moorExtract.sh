...
printf 'Time \t F1x \t F1y \t F1z \t F2x \t F2y \t F2z \t F3x \t F3y \t F3z \t F4x \t F4y \t F4z \n' > MOORING_DATA.dat
...
my_output="$(awk '
	...
	/Restraint catenaryLine3/{F3x=$6; F3y=$7; F3z=$8; next}
	/Restraint catenaryLine4/{F4x=$6; F4y=$7; F4z=$8;
	printf("%8.6f\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",
	TIME,F1x,F1y,F1z,F2x,F2y,F2z,F3x,F3y,F3z,F4x,F4y,F4z);}' $file)"
